...
class PlatformFFI {
  ...
  Future<void> init(String appType) async {
    ...
    try {
      ...
      _ffiBind = createNativeBridge(dylib);
  ...
  void _startListenEvent(dynamic rustdeskImpl) {
    final appType =
